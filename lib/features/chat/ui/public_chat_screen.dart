...
import 'package:public_chat/features/chat/data/chat_data.dart';
...
class PublicChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Expanded(child: FirestoreListView<Message>(
            query: FirebaseFirestore.instance.collection('public')
            .orderBy('time')
                .withConverter(
